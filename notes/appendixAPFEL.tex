...
\begin{array}{rcl}
\beta_1^{(\alpha_s\alpha)} &=& -2\sum_{i=1}^{n_f}e_q^2\,, \\
\qquad\beta_1^{(\alpha\alpha_s)} &=& -\frac{16}{3}N_c\sum_{i=1}^{n_f} e_q^2\,,\\
\qquad\beta_1^{(\alpha^2)} &=& -4\left(n_l+N_c\sum_{i=1}^{n_f} e_q^2\right)\,,
\end{array}
\end{equation}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\columnwidth,angle=270]{figs/couplings.pdf} 
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.95\columnwidth]{figs/lumi_13tev.pdf} 
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.5\columnwidth,angle=270]{figs/NLOQEDCorrections_NC.pdf}
\includegraphics[width=0.5\columnwidth,angle=270]{figs/NLOQEDCorrections_CC.pdf}
