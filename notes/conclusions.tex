...
% in the region of $x$
%where the ATLAS DY data is expected to have sensitivity.
%
...
%
The work of R.~S. has been supported by the BMBF-JINR cooperation,
while the work of P.~S. has been supported in part by Helmholtz Gemeinschaft
under contract VH-HA-101 and the BMBF-JINR cooperation.
%
