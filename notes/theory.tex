...
%
These $K$-factors turn out to be close to $1$, varying by at most $3$\% among
all the data bins. This is also shown in fig.\ref{fig:kf}.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%                                                                                                                                                 
\begin{figure}[h]
\includegraphics[width=7cm]{figs/kf_2D.pdf}
\caption{The size of the k-factors to account for the higher order QCD effects in the QCD fits. Different colors indicate different mass bins.}
\label{fig:kf}
\end{figure}
