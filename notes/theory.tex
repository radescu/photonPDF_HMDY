...
the only available {\tt APPLgrid} implementation and NLO corrections are
...
the numerator and in the denominator. The photon induced contribution, as provided in \cite{Aad:2016zzw},  has been explicitly 
...
The $K$-factors have been computed using
   ...
   %
   Fig.~\ref{fig:kf} shows the $K$-factors  Eq.~({\ref{eq:kfactor})
