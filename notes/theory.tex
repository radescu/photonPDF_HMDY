...
%
  ...
  at most 4\%.
%
In this theoretical formalism, the contribution from the photon induced diagrams 
as compared to the quark- and gluon-induced dilepton production is most relevant at the 
central rapidities and large invariant masses. 
%
For the most central (forward) rapidity bin, $0 < |yll| < 0.2$ ($2.0 < |yll| < 2.4$), the photon 
induced contributions range between 2.5\% (2\%) at low invariant masses and 12\% (2.5\%) for the highest $m_{ll}$ bin
%.
