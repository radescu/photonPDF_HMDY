...
%
Almost 10 years later, the NNPDF\-2.3QED analysis~\cite{Ball:2012cx,Ball:2013hta} provided a first model-independent determination of the photon PDF based on Drell-Yan (DY) data from the LHC.
%
...
strategy is called  LUX\-qed~\cite{Manohar:2016nzj} and its residual uncertainties are now at the few
